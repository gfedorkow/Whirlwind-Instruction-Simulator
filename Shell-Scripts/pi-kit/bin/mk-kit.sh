...
cd ~ 
cp .vimrc  .viminfo  .nanorc .bash_profile .gitconfig  $GPATH/pi-kit

cd ~/bin
cp auto-ping  no-blank  pinger.sh  run-ww  wwasm  ww-shell  wwsim  $GPATH/pi-kit/bin

cd
cp  ~/config-ww $GPATH/pi-kit/config-ww

cp ~/History-of-Computing/Whirlwind/GitHub/.git/config  $GPATH/pi-kit/History-of-Computing/Whirlwind/GitHub/.git/

cp ~/History-of-Computing/Whirlwind/GitHub/Hardware/Micro-Whirlwind/.git/config  $GPATH/pi-kit/History-of-Computing/Whirlwind/Hardware/Micro-Whirlwind/GitHub/.git/
