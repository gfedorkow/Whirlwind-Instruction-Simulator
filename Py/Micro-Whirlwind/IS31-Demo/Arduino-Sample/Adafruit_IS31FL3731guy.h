#ifndef _ADAFRUIT_IS31FL3731_Hguy_
#define _ADAFRUIT_IS31FL3731_Hguy_
...
*/
/**************************************************************************/
class Adafruit_IS31FL3731guy : public Adafruit_GFX {
public:
  Adafruit_IS31FL3731guy(uint8_t x = 16, uint8_t y = 9);
  ...
  void setLEDBytesguy(uint8_t lednum, uint8_t bits_r, uint8_t bits_l);
  void setLEDBufguy(uint8_t reg, uint8_t count, uint16_t *words);
...
*/
/**************************************************************************/
class Adafruit_IS31FL3731guy_Wing : public Adafruit_IS31FL3731guy {
public:
  Adafruit_IS31FL3731guy_Wing(void);
  void drawPixel(int16_t x, int16_t y, uint16_t color);
};
